...
services/findy2_api_client.py # FINDY2 운영 API 선택 연결 클라이언트
auth_gateway/app.py # 소셜 로그인, 문자 인증, PASS 본인확인 연결 게이트웨이
findy_server/        # FINDY2 커뮤니티 운영 API 서버
pages/               # 일부 모듈화된 페이지
...
docs/project/GITHUB_PUSH_SETUP.md    # GitHub 인증과 푸시 준비
```
