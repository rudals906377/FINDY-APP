...
async def main(page: ft.Page):
    ...
    def show_completed_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("완료한 시술", "방문이 끝난 시술 기록을 모아볼 수 있어요."),
                *cards,
                ft.Container(height=24),
            ],
            spacing=SPACE_MD,
    ...
    def show_beauty_profile_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("나의 뷰티 정보", "선호하는 무드와 고민을 간단히 정리해둘 수 있어요."),
                ft.Container(
                    width=content_width(),
                    padding=SPACE_LG,
                    bgcolor="#FFFFFF",
    ...
    def show_notice_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("공지사항", "서비스 운영 소식과 업데이트를 확인할 수 있어요."),
    ...
    def show_feedback_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("개선 의견", "더 나은 FINDY를 만들기 위한 아이디어를 들려주세요."),
                feedback_field,
    ...
    def show_support_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("고객센터", "서비스 이용 중 궁금한 점을 빠르게 해결해보세요."),
                ft.Container(
                    width=content_width(),
                    padding=SPACE_LG,
                    bgcolor="#FFFFFF",
    ...
    def show_inquiry_page():
        ...
        body = ft.Column(
            controls=[
                tab_page_intro("문의내역", "문의 작성과 접수 내역 확인을 한 화면에서 할 수 있어요."),
                ft.Container(
                    width=content_width(),
                    padding=SPACE_LG,
                    bgcolor="#FFFFFF",
    ...
    def snap_sort_chip(label, key):
        ...
        return ft.Container(
            ...
            bgcolor=MAIN_COLOR_SOFT if active else CHIP_BG,
            border_radius=999,
    ...
    def tab_page_intro(title, subtitle):
        return ft.Container(
            ...
            content=ft.Column(
                controls=[
                    ft.Text(title, size=31, weight=ft.FontWeight.W_700, color=TEXT_COLOR),
                        ...
                        controls=[
                            ft.Row(
                                controls=[
                                    ...
                                    ft.Column(
                                        controls=[
                                            ft.Text(main_category, size=15, color=TEXT_COLOR, weight=ft.FontWeight.W_700),
