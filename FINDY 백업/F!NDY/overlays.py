import flet as ft
from components.layout import MAIN_COLOR, SUBTEXT_COLOR, TEXT_COLOR, PHONE_WIDTH, PHONE_HEIGHT, NAV_BAR_HEIGHT, NAV_SAFE_GAP
...
def build_left_overlay(
    *,
            ...
            for sub_category in small_categories:
                item_controls.append(
                    ft.Container(
                        ...
                        border_radius=16,
                        bgcolor="#FFFFFF",
                        border=ft.border.all(1, ft.Colors.with_opacity(0.28, "#DCCCB7")),
    ...
    scrim = ft.Container(
        width=PHONE_WIDTH,
        height=PHONE_HEIGHT,
        bgcolor=ft.Colors.with_opacity(0.22, "#000000"),
