import flet as ft
from components.layout import CARD_COLOR, CHIP_BG, MAIN_COLOR, SPACE_MD, SPACE_LG, RADIUS_XL, SUBTEXT_COLOR, TEXT_COLOR, BORDER_COLOR
...
def soft_button(label, bgcolor, text_color, on_click, border=None, width=300):
    return ft.Container(
        ...
        on_click=on_click,
        ink=True,
        shadow=ft.BoxShadow(spread_radius=0, blur_radius=10, color="#12000000", offset=ft.Offset(0, 3)),
        content=ft.Row(
