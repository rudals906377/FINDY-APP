...
async def main(page: ft.Page):
        ...
        return ft.Container(
            ...
            content=ft.Column(
                controls=[
                    ft.Row(
                        controls=[
                            ft.Text("내정보", size=20, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                            ft.Container(
                                padding=ft.padding.symmetric(horizontal=8, vertical=1),
                                bgcolor=CHIP_BG,
                                border_radius=4,
                                content=ft.Text("내정보 수정", size=10, color=TEXT_COLOR, weight=ft.FontWeight.W_600),
                            ),
                        ],
    ...
    def build_my_info_menu_row(label, icon_name, on_click=None, enabled=True, badge_text=None):
        ...
        row_bgcolor = ft.Colors.TRANSPARENT if enabled else "#F6F1EB"
        ...
        if badge_text:
            trailing_controls.append(
                ft.Container(
                    ...
                    bgcolor=CHIP_BG if enabled else "#E9DED3",
                    border_radius=10,
                    content=ft.Text(
                        badge_text,
                        size=10,
    ...
    def show_review_page():
        ...
        body = ft.Column(
            controls=[
                page_header("후기", on_back=lambda e: show_home_page()),
    ...
    def show_placeholder_info_page(title, description):
        ...
        body = ft.Column(
            controls=[
                ft.Container(width=content_width(), content=ft.TextButton("← 뒤로가기", on_click=lambda e: show_my_page())),
                ft.Container(
                    width=content_width(),
                    padding=SPACE_XL,
    ...
    def show_reservation_history_page():
        ...
        history = app_state.get("reservation_history", [])
        ...
        controls = [
            ...
            ft.Container(
                ...
                content=ft.Column(
                    controls=[
                        ft.Text("예약내역", size=22, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                        ft.Text("내가 신청한 예약을 확인할 수 있어요.", size=13, color=SUBTEXT_COLOR),
                    ],
                    spacing=6,
                ),
            ),
        ...
        if history:
            for item in reversed(history):
                controls.append(
                    ft.Container(
                        ...
                        content=ft.Column(
                            controls=[
                                ft.Text(item["artist_name"], size=16, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                                ft.Text(item["job"], size=10, color=SUBTEXT_COLOR),
                                ft.Text(f'{item["date"]} · {item["time"]}', size=13, color=TEXT_COLOR),
                                ft.Text(item.get("status", "예약 요청 완료"), size=12, color=MAIN_COLOR),
                            ],
                            spacing=5,
                        ),
                    )
            ...
            controls.append(
                ft.Container(
                    width=content_width(),
                    padding=SPACE_XL,
                    bgcolor=ft.Colors.with_opacity(0.74, "#FFFFFF"),
                    border_radius=RADIUS_LG,
                    content=ft.Text("아직 예약 내역이 없어요.", size=13, color=SUBTEXT_COLOR, text_align=ft.TextAlign.CENTER),
                )
            )
        ...
        return ft.Container(
            ...
            content=ft.Column(
                controls=[
                    ...
                    ft.Text(f'{item.get("date", "")}  {item.get("time", "")}', size=13, color=MAIN_COLOR),
                    ft.Text(item.get("status", ""), size=12, color=TEXT_COLOR),
                    ft.Text(
                        f'요청사항: {item.get("note", "") or "없음"}',
                        size=12,
                        color=SUBTEXT_COLOR,
                    ),
                ],
        ...
        implemented_items = [
            {
                ...
                "action": lambda e: show_reservation_history_page(),
                "enabled": True,
            },
            {
                "label": "저장한 뷰티",
                "icon_name": "BOOKMARK_BORDER",
                "action": lambda e: show_saved_page(),
                "enabled": True,
            },
        ]
        preparing_items = [
    ...
    def nav_bar(selected_index):
        ...
        def nav_item(icon_name, active_icon_name, label, index, on_click):
            ...
            return ft.Container(
                ...
                content=ft.Column(
                    controls=[
                        ft.Icon(icon_value, size=16, color=icon_color),
        ...
        return ft.Container(
            ...
            border=ft.border.only(top=ft.BorderSide(0.6, ft.Colors.with_opacity(0.18, "#CFC6BC"))),
            shadow=ft.BoxShadow(
                spread_radius=0,
                blur_radius=10,
                color="#12000000",
    ...
    def category_square(icon_name, label, on_click, expand=True):
        return ft.Container(
            ...
            bgcolor="#F6F1EB",
            border_radius=20,
            border=ft.border.all(1, ft.Colors.with_opacity(0.42, "#FFFFFF")),
            on_click=on_click,
            ink=True,
            content=ft.Column(
                controls=[
    ...
    def feature_card(title, desc, emoji):
        return ft.Container(
            ...
            padding=SPACE_LG,
            bgcolor=ft.Colors.with_opacity(0.76, "#FFFFFF"),
            border_radius=RADIUS_XL,
    ...
    def snap_feature_card(title, desc, emoji, focused=False):
        ...
        return ft.Container(
            ...
            border_radius=0,
            border=ft.border.all(1, ft.Colors.with_opacity(0.40, "#FFFFFF")),
            shadow=ft.BoxShadow(
                spread_radius=0,
                        ...
                        content=ft.Stack(
                            controls=[
                                ...
                                ft.Container(
                                    ...
                                    bgcolor=ft.Colors.with_opacity(0.72, "#FFFFFF"),
                                    border_radius=0,
    ...
    def show_login_page():
        ...
        def animated_login_button(label, bgcolor, text_color, on_click, border=None, width=288, delay_ms=0):
            button = ft.Container(
                width=width,
                height=54,
                bgcolor=bgcolor if bgcolor != CARD_COLOR else ft.Colors.with_opacity(0.92, bgcolor),
                border_radius=20,
                border=border or ft.border.all(1, ft.Colors.with_opacity(0.18, "#FFFFFF")),
                alignment=ft.Alignment(0, 0),
                shadow=ft.BoxShadow(
                    spread_radius=0,
                    blur_radius=14,
        ...
        login_card = ft.Container(
            ...
            gradient=ft.LinearGradient(
                ...
                colors=["#FBF8F4", "#F3ECE4"],
            ),
            border_radius=36,
            border=ft.border.all(1, ft.Colors.with_opacity(0.55, "#FFFFFF")),
            shadow=ft.BoxShadow(
                spread_radius=0,
                blur_radius=28,
                color="#18000000",
            ...
            content=ft.Column(
                controls=[
                    logo_box,                    ft.Container(height=2),
                    animated_login_button("네이버 로그인", "#03C75A", "white", go_to_home("네이버"), width=288, delay_ms=140),
                    animated_login_button("카카오 로그인", "#FEE500", "#191919", go_to_home("카카오"), width=288, delay_ms=220),
                    animated_login_button(
                        "구글 로그인",
                        "#FFFDFC",
                        TEXT_COLOR,
                        go_to_home("구글"),
                    ...
                    animated_login_button("애플 로그인", "#111111", "white", go_to_home("애플"), width=288, delay_ms=380),
                ],
                spacing=14,
                horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                alignment=ft.MainAxisAlignment.CENTER,
    ...
    def show_home_page():
        ...
        search_bar = ft.TextField(
            ...
            height=52,
            border_radius=20,
            border_color=ft.Colors.with_opacity(0.15, "#FFFFFF"),
            focused_border_color=MAIN_COLOR,
            bgcolor=ft.Colors.with_opacity(0.82, "#FFFFFF"),
        ...
        body = ft.Column(
            controls=[
                ...
                ft.Container(
                    ...
                    content=ft.Row(
                        controls=[
                            ft.TextButton("← 뒤로가기", on_click=lambda e: show_snap_page()),
                            ft.Container(expand=True),
                            ft.Container(
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        controls=[
                            ft.Text(f"스냅 {item['id'].upper()}", size=24, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
        ...
        body = ft.Column(
            controls=[
                ...
                ft.Container(
                    ...
                    content=ft.Row(
                        controls=[
                            ft.Text("비디오", size=26, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                            ft.Container(
                                padding=ft.padding.symmetric(horizontal=10, vertical=5),
                                bgcolor=CHIP_BG,
                                border_radius=999,
                                content=ft.Text("숏츠 · 릴스", size=10, color=TEXT_COLOR),
                            ),
                        ],
                        alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                        vertical_alignment=ft.CrossAxisAlignment.CENTER,
    ...
    def show_search_results_page():
        ...
        cards = [
            section_title(header_title, subtitle),
            ft.Container(height=12),
        ]
    ...
    def show_my_page():
        ...
        body = ft.Column(
            controls=[
                page_header("내정보", on_back=safe_go_back),
    ...
    def reservation_choice_chip(label, selected, on_click, width=96):
        return ft.Container(
            width=width,
            padding=ft.padding.symmetric(horizontal=12, vertical=10),
    ...
    def show_reservation_page():
        clear_transient_ui()
        artist = app_state.get("reservation_artist") or app_state.get("detail_artist")
        if not artist:
            show_home_page()
            return
        ...
        calendar_rows.append(ft.Row(controls=header_cells, spacing=6))
        ...
        for week in month_days:
            ...
            for d in week:
                ...
                selectable = in_month and not is_past
                ...
                if not in_month:
                    ...
                    cell = ft.Container(
                        ...
                        height=36,
                        border_radius=14,
                        bgcolor=MAIN_COLOR if active else ("#F6F1EB" if selectable else "#EEE9E2"),
                        border=ft.border.all(1, MAIN_COLOR if active else BORDER_COLOR),
                        alignment=ft.Alignment(0, 0),
                        ...
                        content=ft.Text(
                            ...
                            size=13,
                            weight=ft.FontWeight.W_600,
                            color="white" if active else (TEXT_COLOR if selectable else "#B7AEA4"),
                        ),
                    )
                day_cells.append(cell)
            calendar_rows.append(ft.Row(controls=day_cells, spacing=6))

        time_slots = ["10:00", "11:30", "13:00", "14:30", "16:00", "18:00"]
        time_controls = []
        if selected_date:
            for i in range(0, len(time_slots), 3):
                chunk = time_slots[i:i+3]
                row_controls = []
                for slot in chunk:
                    active = selected_time == slot
                    row_controls.append(
                        ft.Container(
                            expand=True,
                            height=52,
        ...
        body = ft.Column(
            controls=[
                page_header("예약하기", on_back=safe_go_back),
                ft.Container(
                    width=content_width(),
                    padding=SPACE_LG,
                    bgcolor=ft.Colors.with_opacity(0.80, "#FFFFFF"),
                    ...
                    content=ft.Column(
                        controls=[
                            ft.Text(artist["name"], size=15, weight=ft.FontWeight.BOLD, color=MAIN_COLOR),
                            ft.Text(artist["job"], size=12, color=SUBTEXT_COLOR),
                        ],
                        spacing=4,
                    ),
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        controls=[
                            ft.Text("날짜 선택", size=15, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                            ft.Container(
                                width=content_width(),
                                padding=SPACE_MD,
                                bgcolor="#FBF8F4",
                                ...
                                content=ft.Column(
                                    controls=[
                                        ft.Text(month_name, size=15, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                                        ft.Column(
                            ...
                            ft.Text(
                                "시간 선택" if selected_date else "날짜를 먼저 선택해주세요",
                                size=15,
                                weight=ft.FontWeight.BOLD,
                                color=TEXT_COLOR if selected_date else SUBTEXT_COLOR,
                            ),
                            ft.Column(
                                controls=time_controls if selected_date else [
                                    ft.Container(
                                        width=content_width(),
                                        padding=SPACE_MD,
                                        bgcolor="#F6F1EB",
                                        border_radius=4,
                                        content=ft.Text("달력에서 날짜를 선택하면 시간 옵션이 바로 열려요.", size=13, color=SUBTEXT_COLOR),
                                    )
                                ],
                                spacing=8,
                            ),
                            ...
                            ft.Container(
                                ...
                                content=ft.Column(
                                    controls=[
                                        ft.Text(
                                            f'선택한 날짜: {selected_date or "아직 선택 안함"}',
                                            size=13,
                                            color=TEXT_COLOR,
                                        ),
                                        ft.Text(
                                            f'선택한 시간: {selected_time or "아직 선택 안함"}',
                                            size=13,
                                            color=TEXT_COLOR,
                                        ),
                                    ],
                            ...
                            ft.Container(height=8),
                            ft.Text("요청사항", size=15, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                            note_field,
                            ft.Container(height=8),
                            soft_button("예약 확인", MAIN_COLOR, "white", go_next, width=340),
                        ],
                        spacing=SPACE_MD,
                    ),
                ),
    ...
    def show_reservation_confirm_page():
        ...
        body = ft.Column(
            controls=[
                page_header("예약 확인", on_back=safe_go_back),
                ft.Container(
                    width=content_width(),
                    padding=22,
                    bgcolor=ft.Colors.with_opacity(0.80, "#FFFFFF"),
                    ...
                    content=ft.Column(
                        controls=[
                            ...
                            ft.Container(height=10),
                            soft_button("예약 완료", MAIN_COLOR, "white", confirm_reservation, width=340),
                        ],
                        spacing=6,
                    ),
                ),
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        controls=[
                            ...
                            ft.Text(
                                f'{artist["name"]} · {app_state.get("reservation_date")} · {app_state.get("reservation_time")}',
                                size=13,
                                color=SUBTEXT_COLOR,
                                text_align=ft.TextAlign.CENTER,
                            ),
                            ft.Container(height=8),
                            soft_button("예약내역 보기", MAIN_COLOR, "white", go_history, width=300),
                            soft_button("홈으로", CHIP_BG, TEXT_COLOR, go_home, width=300),
                        ],
                        spacing=SPACE_MD,
                        horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                    ),
    ...
    def show_detail_page():
        ...
        content = ft.Column(
            controls=[
                ft.Container(height=10),
                page_header("상세보기", on_back=safe_go_back),
                ft.Container(
                    width=content_width(),
                    height=220,
                    ...
                    content=ft.Column(
                        controls=[
                            ft.Text("FINDY", size=16, weight=ft.FontWeight.BOLD, color=SUBTEXT_COLOR),
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        controls=[
                            ...
                            ft.Container(height=4),
                            ft.Text(artist["style"], size=16, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
                            ...
                            ft.Container(height=10),
                            ft.Text("후기", size=15, weight=ft.FontWeight.BOLD, color=TEXT_COLOR),
